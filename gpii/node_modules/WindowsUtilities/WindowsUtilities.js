...
// https://docs.microsoft.com/windows/desktop/api/winuser/ns-winuser-tagtogglekeys
...
// https://docs.microsoft.com/windows/win32/api/winuser/ns-winuser-rawinputheader
windows.RAWINPUTHEADER = new Struct([
    [t.DWORD, "dwType"],
    [t.DWORD, "dwSize"],
    [t.HANDLE, "hDevice"],
    [t.HANDLE, "wParam"]
...
// https://docs.microsoft.com/windows/win32/api/winuser/ns-winuser-rawmouse
windows.RAWMOUSE = new Struct([
    [t.WORD, "usFlags"],
    [t.WORD, "padding"],
    [t.WORD, "usButtonFlags"],
    [t.WORD, "usButtonData"],
...
windows.RAWKEYBOARD = new Struct([
    [t.WORD, "MakeCode"],
    [t.WORD, "Flags"],
    [t.WORD, "Reserved"],
    [t.WORD, "VKey"],
...
windows.RAWHID = new Struct([
    [t.DWORD, "dwSizeHid"],
    [t.DWORD, "dwCount"],
    [arrayType("char", 1), "bRawData"]
]);

// https://docs.microsoft.com/windows/win32/api/winuser/ns-winuser-rawinput
// Representes a case of the RAWINPUT structure in which the union holds a RAWMOUSE structure.
windows.RAWINPUTMOUSE = new Struct([
    [windows.RAWINPUTHEADER, "header"],
    [windows.RAWMOUSE, "mouse"]
]);

// https://docs.microsoft.com/windows/win32/api/winuser/ns-winuser-rawinput
// Representes a case of the RAWINPUT structure in which the union holds a RAWKEYBOARD structure.
windows.RAWINPUTKEYBOARD = new Struct([
    [windows.RAWINPUTHEADER, "header"],
    [windows.RAWKEYBOARD, "keyboard"]
]);

// https://docs.microsoft.com/windows/win32/api/winuser/ns-winuser-rawinput
// Representes a case of the RAWINPUT structure in which the union holds a RAWHID structure.
windows.RAWINPUTHID = new Struct([
    [windows.RAWINPUTHEADER, "header"],
    [windows.RAWHID, "mouse"]
]);

// https://docs.microsoft.com/en-us/windows/win32/api/winuser/ns-winuser-rawinputdevice
windows.RAWINPUTDEVICE = new Struct([
    [t.WORD, "usUsagePage"],
    [t.WORD, "usUsage"],
    [t.DWORD, "dwFlags"],
    [t.ULONG, "hwndTarget"]
...
windows.flagConstants = {
    ...
    // FORMATMESSAGE flags
    // https://docs.microsoft.com/windows/desktop/Debug/retrieving-the-last-error-code
...
gpii.windows.getUsbDrives = function (drivePaths) {
    ...
    drives = drives.filter(function (drivePath) {
        ...
        // Return this drive if it's a USB and the path exists.
        return busType === BusTypeUsb && fs.existsSync(drivePath);
    });
 ...
 * @param {Boolean} options.local Flag that if not true disables normal behavior and does nothing. TODO: This is a hack
 *  related with GPII-4087.
...
gpii.windows.rm = function (path, options) {
    ...
    // GPII-4087 Hack. Do nothing if options.local option is not set.
